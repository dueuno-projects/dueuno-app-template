...
[subs="attributes"]
----
cmd /C "set JAVA_OPTS="-Dmicronaut.config.files=C:/path/to/config.yml" && C:/path/to/bin/{application-name}.bat"
----

.Unix
[subs="attributes"]
----
JAVA_OPTS="-Dmicronaut.config.files=/path/to/config.yml" /path/to/bin/{application-name}
----
